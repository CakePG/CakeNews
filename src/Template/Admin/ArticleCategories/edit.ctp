<?php
  $this->layout = 'admin';
  $this->assign('title', __d('CakeNews', 'News Category').'編集 - '.__d('CakeNews', 'Website Admin Title').' | '.__d('CakeNews', 'Website Title'));
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active" aria-current="page"><?= __d('CakeNews', 'News Category') ?><?= __d('CakeNews', 'News Category') ?>編集</li>
</ol>

<div class="container">
  <div class="row align-items-end mb-2">
    <div class="col-md">
      <h2><?= __d('CakeNews', 'News Category') ?>編集<hr class="d-none d-md-block"></h2>
    </div>
  ...
  <div class="card admin">
    <div class="card-header">
      <nav class="nav nav-pills nav-fill">
        ...
        <?= $this->Html->link('<i class="fa fa-angle-left" aria-hidden="true"></i>詳細へ', ['action' => 'view', $articleCategory->id]+$this->request->query, ['class' => 'btn btn-sm btn-light', 'escape' => false]) ?>
      </nav>
    </div>
    <div class="card-body">
